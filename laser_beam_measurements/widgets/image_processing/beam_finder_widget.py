...
class BeamFinderWidget(ImageProcessorViewerBase):
    ...
    def _connect_processor_signal(self) -> None:
        ...
        #     self.roi.signal_region_changed.connect(self._image_processor.slot_set_state)
    ...
    def _disconnect_processor_signal(self) -> None:
        ...
        #     self.roi.signal_region_changed.disconnect(self._image_processor.slot_set_state)
